...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'gcs' => [
            'driver' => 'gcs',
            'key_file_path' => env('GOOGLE_CLOUD_KEY_FILE', null), // Leave null if using key_file array
            'key_file' => json_decode(base64_decode(env('GOOGLE_CLOUD_KEY_FILE_BASE64')), true), // Decodes JSON string to array
